...
- The current live release is commit `36be015` with cache key `20260716-04`; it includes type-aware question stimuli and the corrected Study Hub active-run vertical composition.
